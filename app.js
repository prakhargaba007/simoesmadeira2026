...
const programa = [
  {
    ...
    prog: 'Chegada do grupo 1 de madrugada. Um primeiro dia tranquilo e a pé pelo Funchal: Mercado dos Lavradores, centro histórico e a experiência icónica do teleférico do Monte com a descida nos Carros de Cesto. Tarde a abrandar nas piscinas.',
    horario: [
      ...
      { h: '10:30', txt: 'Mercado dos Lavradores — frutas exóticas, peixe, flores.' },
      { h: '11:30', txt: 'Passeio a pé pelo centro histórico: Sé, Rua de Santa Maria (arte das portas), marginal.' },
      ...
      { h: '17:30', txt: 'Regresso ao hotel. Resto da tarde nas piscinas, a descansar da viagem.' },
      { h: '20:00', txt: 'Jantar no hotel (meia pensão).' },
    ],
    nota: 'Dia propositadamente tranquilo e tudo no Funchal — o grupo chega cansado do voo das 06:25 e falta a família do Jorge (só chega no dia 6). Os Carros de Cesto são uma experiência rápida (~10 min) e icónica, ideal para o primeiro dia.',
    almoco: [
      { nome: 'Gavião Novo (centro histórico)', desc: 'Casa de peixe e marisco bem conceituada na Rua de Santa Maria, com salas amplas. Aceita reserva — pedir mesa para o grupo.', grupo: 'Bom para grupos · reservar', maps: 'Restaurante Gavião Novo Funchal' },
      { nome: 'Santa Maria (centro histórico)', desc: 'Petiscos modernos e pizzas numa casa animada da zona velha, com espaço e mesas grandes. Boa para um almoço descontraído de chegada.', grupo: 'Bom para grupos · reservar', maps: 'Restaurante Santa Maria Funchal' },
    ],
    locais: [
  ...
  },
  {
    ...
    almoco: [
      ...
      { nome: 'Cervejaria Beerhouse (Marina)', desc: 'Na marina do Funchal, espaço grande e esplanada sobre o mar — prático mesmo após o barco. Boa opção para grupos.', grupo: 'Bom para grupos · reservar', maps: 'Beerhouse Funchal Marina' },
    ],
    locais: [
  ...
  },
  {
    ...
    horario: [
      { h: '10:00', txt: 'Manhã livre no Funchal. Boa altura para fazer o teleférico + Carros de Cesto do Monte, se ainda não os tiverem feito.' },
      { h: '12:00', txt: 'Check-out do hotel.' },
    ...
    nota: 'A família do Jorge vai de táxi para o aeroporto (o mini-bus não cobre este dia). Para 5 pessoas com bagagem são precisos 2 táxis normais, ou pode pedir-se um táxi grande / carrinha. Dica: o teleférico e os Carros de Cesto ficam no Funchal e são rápidos — fáceis de fazer nesta manhã livre, caso queiram a experiência que o grupo 1 fez no dia 5.',
    locais: [
      { nome: 'Carreiros do Monte', placeId: PLACES.cestos },
      { nome: 'Aeroporto da Madeira (FNC)', placeId: PLACES.airport },
    ],
...
const reembolsosVoos = [
  ...
  },
  {
    ...
    pessoas: [
      ...
      { nome: 'Conceição',  voo: 161.88, lugar: 17.48, mala: 20.49, pago: true },
    ],
  },
  {
  ...
  },
  {
    ...
    pessoas: [
      ...
      { nome: 'Ana Maria', voo: 161.88, lugar: 17.48, mala: 20.49, pago: true },
    ],
  },
  {
